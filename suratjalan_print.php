...
<body>
      ...
      <tr>
        ...
        <tr>
        <th width="596" align="center"><h1>FAKTUR <?php echo $surat;?></h1></th>
      </tr>
...
<table width="100%" border="0" bgcolor="#000000">
      <tbody>
        ...
        <th width="3%" scope="col">Harga</th>
        <th width="3%" scope="col">Total</th>
 ...
 <?php
    ...
    <tr bgcolor="white">
              ...
              <td><?php  echo mysqli_real_escape_string($conn, $fill['nama']); ?></td>
               <td align="center"><?php echo number_format(mysqli_real_escape_string($conn, $fill['jumlah']), 0, '.', '.'); ?></td>
        <td align="center"><?php  $cba =$fill['kode_barang'];
        $r=mysqli_fetch_assoc(mysqli_query($conn,"SELECT satuan FROM barang WHERE kode='$cba'"));
       echo mysqli_real_escape_string($conn, $r['satuan']); ?></td>
                <td>Rp. <?php  $cba =$fill['kode_barang'];
        $r=mysqli_fetch_assoc(mysqli_query($conn,"SELECT hargajual FROM barang WHERE kode='$cba'"));
       echo number_format(mysqli_real_escape_string($conn, $r['hargajual']), 0, '.', '.'); ?>,00</td>
                <td>Rp. <?= number_format(mysqli_real_escape_string($conn, $r['hargajual']*$fill['jumlah']), 0, '.', '.'); ?>,00</td>
