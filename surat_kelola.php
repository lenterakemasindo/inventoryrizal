...
<tr>
           ...
           <a class="btn btn-success btn-xs" href="surat_print?nota=<?php  echo $fill['nota']; ?>" target="_blank">Cetak SJ</a>
           <a class="btn btn-success btn-xs" href="suratjalan_print?nota=<?php  echo $fill['nota']; ?>" target="_blank">Cetak Faktur</a>
           <?php } else {}?>
